...
Vesc can only have 1 user QML app running. ADC or any other buit in app that uses the three main motor controls: SetRPM,SetDuty or SetCurrent - they will *FIGHT*
each other and end up in a right old mess.
